      ...
      <div className="container mx-auto flex max-w-md flex-col items-center justify-center">
        ...
        <Card className="w-full border-2 border-blue-100">
          <CardHeader className="bg-gradient-to-r from-blue-50 to-purple-50">
            ...
            <CardTitle className="text-center text-2xl text-blue-700">Welcome Back!</CardTitle>
            <CardDescription className="text-center">Log in to continue your math adventure</CardDescription>
          </CardHeader>
